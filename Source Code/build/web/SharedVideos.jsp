...
<div class="wrapper col5">
  <div id="container">
    <div id="content">
        <table>
            <tr>
                <th>Video Shared By</th><th>Video Name</th>
            </tr>
       <%
       try{
       String query="select * from share where fid='"+id+"'";
...
String vid=r.getString("vid");
    ...
    <tr>
        ...
        <td><a href="playVideo1.jsp?fname=<%=r.getString("videoname")%>&vid=<%=r.getString("vid")%>"><%=r.getString("videoname")%></a></tD> 
