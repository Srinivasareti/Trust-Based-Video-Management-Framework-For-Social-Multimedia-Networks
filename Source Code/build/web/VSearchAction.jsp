...
<div class="wrapper col5">
  <div id="container">
    <div id="content">
       ...
       <%
       try{
       String query="select * from video where fname like '%"+vname+"%'";
    ResultSet r=Queries.getExecuteQuery(query);
    while(r.next()){
        String status=r.getString("status");
        if(status.equals("Active")){
    String id2=r.getString("id");    
ResultSet rs=Queries.getExecuteQuery("select * from video where id='"+id2+"'");
int hh=0;
if(rs.next()){
    int ii=Integer.parseInt(rs.getString("rank"));
   hh=ii+1; 
}

Queries.getExecuteUpdate("update video set rank='"+hh+"'where id='"+id2+"'");
...
%>
<font color="red">This is video is Blocked By the Server</font>
<%
} 
    }
